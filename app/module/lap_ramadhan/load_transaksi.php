...
if(!$_SESSION){
    ...
    $sqlZakatMal = "SELECT 
                        ...
                        tgl_donasi BETWEEN '$dari' AND '$sampai' AND kode_daerah='$kode_daerah'

                        AND kode_prg_pnr='101-3302001' AND status !='REJECT'";
    ...
    $sqlZakatProfesi = "SELECT 
                    ...
                    AND kode_prg_pnr='101-3302002' AND status !='REJECT'";
    ...
    $sqlZakatFitrah = "SELECT 
                    ...
                    AND kode_prg_pnr='101-3302004' AND status !='REJECT'";
    ...
    $sqlMuzakiIndividuZakatMal = "SELECT 
                    ...
                    AND kode_prg_pnr='101-3302001' AND jenis_donatur='Individu' AND status !='REJECT'";
    ...
    $sqlMuzakiIndividuZakatProfesi = "SELECT 
                    ...
                    AND kode_prg_pnr='101-3302002' AND jenis_donatur='Individu' AND status !='REJECT'";
    ...
    $sqlMuzakiIndividuZakatFitrah = "SELECT 
                    ...
                    AND kode_prg_pnr='101-3302004' AND jenis_donatur='Individu' AND status !='REJECT'";
    ...
    $sqlMuzakiEntitasZakatMal = "SELECT 
                    ...
                    AND kode_prg_pnr='101-3302001' AND jenis_donatur='Entitas' AND status !='REJECT'";
    ...
    $sqlMuzakiEntitasZakatProfesi = "SELECT 
                    ...
                    AND kode_prg_pnr='101-3302002' AND jenis_donatur='Entitas' AND status !='REJECT'";
    ...
    $sqlMuzakiEntitasZakatFitrah = "SELECT 
                    ...
                    AND kode_prg_pnr='101-3302004' AND jenis_donatur='Entitas' AND status !='REJECT'";
    ...
    $sqlInfakSedekah = "SELECT 
                    ...
                    AND kode_prg_pnr='102-3302001' AND status !='REJECT'";
    ...
    $sqlKadoRamadhan = "SELECT 
                    ...
                    AND kode_prg_pnr='102-3302005' AND status !='REJECT'";
    ...
    $sqlFilantropiCilik = "SELECT 
                    ...
                    AND kode_prg_pnr='102-3302008' AND status !='REJECT'";
    ...
    $sqlBackToMasjid = "SELECT 
                    ...
                    AND kode_prg_pnr='102-3302004' AND status !='REJECT'";
    ...
    $sqlMudikmu = "SELECT 
                    ...
                    AND kode_prg_pnr='102-3302003' AND status !='REJECT'";
    ...
    $sqlIndividuInfakSedekah = "SELECT 
                    ...
                    AND kode_prg_pnr='102-3302001' AND jenis_donatur='Individu' AND status !='REJECT'";
    ...
    $sqlIndividuKadoRamadhan = "SELECT 
                    ...
                    AND kode_prg_pnr='102-3302005' AND jenis_donatur='Individu' AND status !='REJECT'";
    ...
    $sqlIndividuFilantropi = "SELECT 
                    ...
                    AND kode_prg_pnr='102-3302008' AND jenis_donatur='Individu' AND status !='REJECT'";
    ...
    $sqlIndividuBack = "SELECT 
                    ...
                    AND kode_prg_pnr='102-3302004' AND jenis_donatur='Individu' AND status !='REJECT'";
    ...
    $sqlIndividuMudikmu = "SELECT 
                    ...
                    AND kode_prg_pnr='102-3302003' AND jenis_donatur='Individu' AND status !='REJECT'";
    ...
    $sqlEntitasInfakSedekah = "SELECT 
                    ...
                    AND kode_prg_pnr='102-3302001' AND jenis_donatur='Entitas' AND status !='REJECT'";
    ...
    $sqlEntitasKadoRamadhan = "SELECT 
                    ...
                    AND kode_prg_pnr='102-3302005' AND jenis_donatur='Entitas' AND status !='REJECT'";
    ...
    $sqlEntitasFilantropi = "SELECT 
                    ...
                    AND kode_prg_pnr='102-3302008' AND jenis_donatur='Entitas' AND status !='REJECT'";
    ...
    $sqlEntitasBack = "SELECT 
                    ...
                    AND kode_prg_pnr='102-3302004' AND jenis_donatur='Entitas' AND status !='REJECT'";
    ...
    $sqlEntitasMudikmu = "SELECT 
                    ...
                    AND kode_prg_pnr='102-3302003' AND jenis_donatur='Entitas' AND status !='REJECT'";
