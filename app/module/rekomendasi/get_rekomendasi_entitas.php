...
if(!$_SESSION){
    ...
    if($kode_daerah == ''){
        ...
        $sql	= "SELECT 
                ...
                WHERE kode_daerah='$kode_daerah' AND nama_lembaga !='' AND status ='PROSES SURVEY' 

                OR kode_daerah='$kode_daerah' AND nama_lembaga !='' AND status ='REKOMENDASI'
        ...
        $sql	= "SELECT 
                ...
                WHERE no_kantor='$no_kantor' AND nama_lembaga !='' AND status ='PROSES SURVEY' 

                OR no_kantor='$no_kantor' AND nama_lembaga !='' AND status ='REKOMENDASI'
