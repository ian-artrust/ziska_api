...
if(!$_SESSION){
    ...
    $data   = "<h4><b>Laporan Penerimaan Kantor Layanan</b></h4>
    ...
    while ($row_hdr = $hasilHeader->fetch_assoc()) {
        ...
        if($kode_daerah==''){
            ...
            WHERE tgl_donasi BETWEEN '$dari_tgl' AND '$sampai_tgl' AND no_kantor='$no_kantor' AND kategori='$rwh'";
            ...
            WHERE tgl_donasi BETWEEN '$dari_tgl' AND '$sampai_tgl' AND no_kantor='$no_kantor
