...
if(!$_SESSION){
    ...
    $dari_bank_tgl       = $_POST['dari_bank_tgl'];

    $sampai_bank_tgl     = $_POST['sampai_bank_tgl'];
    ...
    if($kode_petugas==''){
        ...
        WHERE tgl_donasi BETWEEN '$dari_bank_tgl' AND '$sampai_bank_tgl' 
        
        AND kode_daerah='$kode_daerah' AND metode='MUTASI BANK' AND status='Aktif'
        ...
        AND metode='MUTASI BANK' AND createdby='$kode_petugas' 
        
        AND kode_daerah='$kode_daerah' AND status='Aktif'
