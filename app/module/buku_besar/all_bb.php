...
if(!$_SESSION){
    ...
    $sqlTotal	= "SELECT 
                    ...
                    WHERE periode='$periode_bb' AND kode_daerah='$kode_daerah' AND status !='REJECT' 
        ...
        $data .= "
            ...
            if($kode_daerah==''){
                ...
                $sql	= "SELECT 
                        ...
                        WHERE periode='$periode_bb' AND kode_akun='$kode_akun_dtl' AND status !='REJECT'";
                ...
                $sql	= "SELECT 
                        ...
                        WHERE periode='$periode_bb' AND kode_daerah='$kode_daerah' 
                        
                        AND kode_akun='$kode_akun_dtl' AND status !='REJECT'
