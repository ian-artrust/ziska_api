...
if(!$_SESSION){
    ...
    $no_batal_penyusutan = $_POST['no_batal_penyusutan'];

    $sqljurnal = "SELECT no_jurnal FROM trs_juhdr WHERE ref_number='$no_batal_penyusutan'";
    ...
    $sqlBatalSetup = "UPDATE trs_pny_asset SET status='REJECT' WHERE no_penyusutan='$no_batal_penyusutan' ";
    ...
    } elseif($no_batal_penyusutan==""){

        $pesan 		= "Pilih Penyusutan Yang Akan Dibatalkan";
