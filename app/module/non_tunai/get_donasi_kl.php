...
if(!$_SESSION){
    ...
    if($kode_petugas=='' AND $kode_daerah==''){
        ...
        $sql	= "SELECT 
                ...
                WHERE status='Aktif' AND no_kantor='$no_kantor' AND createdby='$kode_petugas' AND kode_daerah='$kode_daerah' AND jenis='Penerimaan Zakat Non Tunai'
                
                OR status='Aktif' AND no_kantor='$no_kantor' AND createdby='$kode_petugas' AND kode_daerah='$kode_daerah' AND jenis='Penerimaan Infak Terikat Non Tunai'
                
                OR status='Aktif' AND no_kantor='$no_kantor' AND createdby='$kode_petugas' AND kode_daerah='$kode_daerah' AND jenis='Penerimaan Infak Tidak Terikat Non Tunai'";
